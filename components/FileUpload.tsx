    ...
    <div className="mb-3">
      <button
        ...
        style={{
          ...
          background: dragOver ? "#C8340608" : "transparent",
        }}
      >
        {state === "loading" ? (
          <>
          ...
          <>
            ...
            <p className="text-sm text-[var(--text-muted)]">
              <span style={{ color: dragOver ? "var(--accent-on-tint)" : "var(--accent)" }}>Click to upload</span> or drag & drop
            </p>
            <p className="text-xs text-[var(--text-muted)]">PDF, DOCX, TXT, MD, CSV supported</p>
          </>
        )}
      </button>
