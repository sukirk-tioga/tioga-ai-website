        ...
        <div className="space-y-10">
          ...
          <div>
            ...
            <p className="text-sm text-[var(--text-muted)] leading-relaxed mb-4">
              ...
              exist. See{" "}
              <Link href="/mcp/vs-custom-integration" style={{ color: "var(--accent)" }} className="underline underline-offset-2 hover:text-[var(--text)] transition-colors">
          ...
          <div>
            ...
            <div role="region" aria-label="Table: MCP versus RPA side by side" tabIndex={0} className="overflow-x-auto rounded-2xl" style={{ border: "1px solid var(--border)" }}>
