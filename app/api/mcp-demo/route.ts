...
**PeopleSoft (HR)**:
${JSON.stringify(MOCK_MCP_DATA.peoplesoft, null, 2)}
...
<mcp_calls>
{"tools": ["PeopleSoft::getEmployees" | "Salesforce::getOpportunities" | "SAP::getInvoices"], "system": "which system(s) you queried"}
</mcp_calls>`;
